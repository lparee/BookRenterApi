...
namespace Carts.Data.Migrations
{
    ...
    [Migration("20240306165232_dbresetup2")]
    partial class dbresetup2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Carts.Core.Entities.Cart", b =>
                {
                    ...
                    b.Property<int>("UserPrfUserId")
                        .HasColumnType("int");

                    b.HasKey("CartId")
                        .HasName("PK_Cart_CartId");

                    b.HasIndex("UserPrfUserId");
            ...
            modelBuilder.Entity("Carts.Core.Entities.Cart", b =>
                {
                    b.HasOne("Carts.Core.Entities.UserProfile", "UserPrf")
                        .WithMany()
                        .HasForeignKey("UserPrfUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserPrf");
                });
